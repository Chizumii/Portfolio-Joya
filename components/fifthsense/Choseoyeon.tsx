...
export default function ChoSeoYeon() {
    return (
        <div className="relative w-screen h-screen overflow-y-auto overflow-x-hidden">
            ...
            <main className="relative z-10 flex-1 hwang-content">
                ...
                <span className="hwangz">Cho Seo-yeon</span>
                <span className="hwangndesc">Cho Seo-yeon is the older sister of two. She have a very mature and elegant appearance. She is a very reliable person making her the mom friend of the group. </span>


                <div className="hwangdetail">
                    <Image
                        src="/assets/chodetail.svg"
                        alt="hwangdetail"
                        width={60}
                        height={60}
                        style={{ width: '100%', height: 'auto' }}
