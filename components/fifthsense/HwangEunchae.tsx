...
export default function HwangEunchae() {
    return (
        <div className="relative w-screen h-screen overflow-y-auto overflow-x-hidden">
            ...
            <main className="relative z-10 flex-1 hwang-content">
                ...
                <span className="hwangz">Hwang Eun-chae</span>
                <span className="hwangndesc">Hwang Eun-chae is the only girl among her siblings, she is a very <br /> lovely and sweet person with a hint of dramatic flare.</span>


                <div className="hwangdetail">
                    <Image
                        src="/assets/hwangdetail.svg"
                        alt="hwangdetail"
                        width={60}
                        height={60}
                        style={{ width: '100%', height: 'auto' }}
