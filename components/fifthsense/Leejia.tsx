...
export default function Leejia() {
    return (
        <div className="relative w-screen h-screen overflow-y-auto overflow-x-hidden">
            ...
            <main className="relative z-10 flex-1 hwang-content">
                ...
                <span className="hwangz">Lee Ji-a</span>
                <span className="hwangndesc">Lee Ji-a fell in love with the charismatic outfit her parents brought back from overseas. Despite looking very cold and distant, she is a very caring and independent person.</span>


                <div className="hwangdetail">
                    <Image
                        src="/assets/leedetail.svg"
                        alt="hwangdetail"
                        width={60}
                        height={60}
                        style={{ width: '100%', height: 'auto' }}
